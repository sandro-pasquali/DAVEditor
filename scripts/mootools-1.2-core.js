...
/**
 * To deal with the upgrade call for Mootools around its broken way of feature detection 
 * (.getBoxObjectFor) changed the detection to use AXIS.isGecko.  This will all get fixed 
 * when a proper upgrade for mootools is done... for now, just for editor.
 */

}else{if(AXIS.isGecko){Browser.Engine={name:"gecko",version:(document.getElementsByClassName)?19:18};
